...
private class SmfReader(private val bytes: ByteArray) {
    ...
    fun readAscii4(): String = bytes.decodeToString(pos, pos + 4).also { pos += 4 }
...
fun parseSmfToPianoRollIndex(bytes: ByteArray): PianoRollIndex? {
...
fun tickToMsFast(tick: Int, anchors: List<TickTimeAnchor>): Long {
